    ...
    <>
      <header
        className={cn(
          ...
          isSticky
            ? 'sticky-header fixed left-0 top-0 w-full animate-fadeInDown bg-white [box-shadow:0px_0px_15px_10px_rgba(25,101,223,.1)] dark:bg-accent-700'
            : 'absolute pt-30px'
        )}
      >
        <Container>
          <div className="flex bg-accent-100 dark:bg-accent-700">
            {/* Brand logo  */}
            <div className="[&_.logo-light] grid flex-none place-items-center bg-primary px-9 py-6 dark:bg-[#212124]">
              {/* [&_.logo-light]:[filter:brightness(0)_invert(1)] */}
              <BrandLogo />
            </div>
