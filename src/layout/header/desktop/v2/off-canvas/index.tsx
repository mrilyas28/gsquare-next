...
const offCanvasProps: IOffCanvas = {
  description:
    'We believe in leveraging the power of technology to drive business success. With our comprehensive suite of IT services, we are committed to helping businesses navigate the complexities of the digital landscape and achieve their full potential.',
  contactInfo: {
    location: 'Block 17, #01-01, Bedok reservoir view singapore 478934',
    phoneNumber: '+65 84284771',
