      ...
      <Container>
        <div className="grid items-start gap-10 md:grid-cols-[390px_1fr] 2xl:gap-[50px]">
          ...
          <div className="grid gap-10 md:sticky md:top-[76px] lg:top-[133px] 2xl:gap-[60px]">
            ...
            <div
              className={cn(
                ...
                // after
                'before:absolute before:inset-0 before:z-[2] before:[background:linear-gradient(180deg,rgba(30,140,244,0.00)_0%,rgba(30,140,244,0.22)_100%)]'
              )}
            >
              <Image
            ...
            <div className="grid gap-30px">
              <div className="relative z-1 bg-accent-100 p-10 dark:bg-accent-700">
                <p>
                  Elevate your online presence with stunning, functional web
                  solutions. Our expert team crafts visually captivating,
                  user-centric websites that not only look impressive but drive
                  results. From responsive designs that shine on every device to
                  powerful e-commerce platforms that boost sales, we bring your
                  digital vision to life. Let us transform your ideas into an
                  engaging online experience that leaves a lasting impression
                  and keeps your audience coming back for more.
                </p>
          ...
          <div className="grid gap-6">
            ...
            <p>
              At GSquare Technologies, we specialize in creating visually
              stunning and functionally robust websites. Our comprehensive web
              design and development services include custom design, SEO
              optimization, social media marketing, and hosting solutions,
              ensuring your online presence is impactful and effective.
            </p>
            <p>
              Our expert team collaborates closely with you to understand your
              brand and goals, delivering a website that not only looks great
              but also performs excellently. From responsive design to seamless
              user experience, we ensure your site stands out and drives
              engagement.
            </p>
            <div className="my-10 grid items-center gap-8 md:grid-cols-2">
              ...
              <div className="grid gap-4">
                <div className="grid gap-3">
                  ...
                  <p>
                    We create custom designs that reflect your brands identity,
                    ensuring your website is unique and visually appealing.
                  </p>
                </div>
                <div className="grid gap-3">
                  <div className="flex items-center gap-4">
                  ...
                  <p>
                    Our SEO optimization services help your website rank higher
                    in search engine results, driving more traffic and
                    visibility.
                  </p>
                </div>
              </div>
            ...
            <p>
              With our web design and development services, you can be confident
              that your website will not only look great but also perform
              effectively, driving your business forward. Experience the
              difference with GSquare Technologies.
            </p>
            ...
            <div className="mt-2.5 grid grid-cols-1 gap-6 md:grid-cols-[1fr_260px]">
              <div className="grid items-baseline gap-6 lg:gap-9">
                <div>
                  ...
                  <p>
                    From design to development, SEO, and marketing, we offer //
                    comprehensive services to cover all your web needs.Our //
                    solutions are tailored to your specific requirements, //
                    ensuring your website perfectly aligns with your business //
                    goals.
                  </p>
                </div>
                <div>
                  <h3 className="text-md font-bold text-accent-700 dark:text-white">
                    Hosting Solutions and Social Media Marketing
                  </h3>
                  <p>
                    Our reliable hosting solutions ensure your website is always
                    up and running, providing a seamless experience for your
                    users.We integrate social media marketing strategies to
                ...
                <div>
                  ...
                  <p>
                    ...
                    website remains up-to-date and fully functional.
                  </p>
                </div>
              </div>
              <Image
