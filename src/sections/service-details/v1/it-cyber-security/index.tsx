...
const services: LinkProps[] = [
  ...
  {
    label: 'Data Encryption Services',
    href: '/services/it-cyber-security',
  },
  {
      ...
      <Container>
        <div className="grid items-start gap-10 md:grid-cols-[390px_1fr] 2xl:gap-[50px]">
          ...
          <div className="grid gap-10 md:sticky md:top-[76px] lg:top-[133px] 2xl:gap-[60px]">
            ...
            <div className="grid gap-30px">
              <div className="relative z-1 bg-accent-100 p-10 dark:bg-accent-700">
                <p>
                  Fortify your digital fortress with our cutting-edge
                  cybersecurity solutions. In a world where threats evolve by
                  the minute, we provide the shield your business needs. Our
                  expert team employs advanced strategies to detect, prevent,
                  and neutralize cyber threats, ensuring your data remains
                  secure and your operations uncompromised. Do not just react to
                  cyber risks - stay ahead with our proactive protection.
                </p>
          ...
          <div className="grid gap-6">
            ...
            <p>
              In todays digital landscape, robust cybersecurity is essential for
              every business. Our IT Cyber Security services provide proactive
              protection and rapid response to safeguard your critical data and
              systems from evolving threats. With our expertise and cutting-edge
              solutions, you can operate with confidence knowing your digital
              assets are secure.
            </p>
            <p>
              We understand the unique challenges businesses face in maintaining
              a strong security posture. Our team of experienced cybersecurity
              professionals works closely with you to assess your risk profile,
              identify vulnerabilities, and implement tailored security
              strategies that align with your business objectives. Whether you
              need comprehensive threat intelligence, security audits, or
              employee training, we have got you covered.
            </p>
            <div className="my-10 grid items-center gap-8 md:grid-cols-2">
              ...
              <div className="grid gap-4">
                <div className="grid gap-3">
                  ...
                  <p>
                    Our advanced threat detection systems use machine learning
                    and behavioral analytics to swiftly identify and neutralize
                    cyber threats in real-time, ensuring continuous protection
                    for your business.
                  </p>
                </div>
                <div className="grid gap-3">
                  ...
                  <p>
                    Our incident response team swiftly contains threats,
                    minimizes damage, and ensures a prompt recovery, minimizing
                    disruption.
                  </p>
                </div>
              </div>
            ...
            <p>
              Dont leave your cybersecurity to chance. Partner with us for
              comprehensive IT Cyber Security services that deliver peace of
              mind. Our proactive approach, combined with our deep technical
              expertise, ensures your business stays one step ahead of cyber
              threats. Trust us to safeguard your digital assets, so you can
            ...
            <div className="mt-2.5 grid grid-cols-1 gap-6 md:grid-cols-[1fr_260px]">
              <div className="grid items-baseline gap-6 lg:gap-9">
                <div>
                  ...
                  <p>
                    Our security experts continuously monitor your systems for
                    potential threats and anomalies. We leverage advanced
                    analytics and real-time alerts to detect and respond to
                    incidents swiftly, minimizing the impact on your operations.
                  </p>
                </div>
                <div>
                  <h3 className="text-md font-bold text-accent-700 dark:text-white">
                  ...
                  <p>
                    We help you navigate the complex landscape of regulatory
                    compliance. Whether its GDPR, HIPAA, or industry-specific
                    standards, our team ensures your security practices are
                    aligned with relevant regulations, avoiding costly
                    penalties.
                  </p>
                </div>
                <div>
                  ...
                  <p>
                    Empower your employees to be your first line of defense. We
                    provide comprehensive training programs to educate your
                    staff on cybersecurity best practices, fostering a culture
