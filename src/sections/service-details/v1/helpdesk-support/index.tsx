...
const services: LinkProps[] = [
  ...
  // },
  {
    label: 'Network Issue Resolution',
    href: '/',
  },
  {
      ...
      <Container>
        <div className="grid items-start gap-10 md:grid-cols-[390px_1fr] 2xl:gap-[50px]">
          ...
          <div className="grid gap-10 md:sticky md:top-[76px] lg:top-[133px] 2xl:gap-[60px]">
            ...
            <div className="grid gap-30px">
              <div className="relative z-1 bg-accent-100 p-10 dark:bg-accent-700">
                <p>
                  Experience uninterrupted productivity with our responsive
                  helpdesk support. We are your IT lifeline, providing swift
                  solutions to tech challenges 24/7. From minor glitches to
                  complex issues, our expert team ensures your business runs
                  smoothly. Maximize efficiency, minimize downtime, and focus on
                  what you do best - we have got your tech covered.
                </p>
          ...
          <div className="grid gap-6">
            ...
            <p>
              At GSquare Technologies, we offer around-the-clock helpdesk
              support to ensure your business operates smoothly without
              interruptions. Our services include issue resolution, remote
              support, and proactive maintenance to prevent issues before they
              arise.
            </p>
            <p>
              Our dedicated team is always ready to assist, providing timely and
              effective solutions to keep your systems running efficiently. From
              troubleshooting to preventive maintenance, we ensure your IT
            ...
            <div className="my-10 grid items-center gap-8 md:grid-cols-2">
              ...
              <div className="grid gap-4">
                <div className="grid gap-3">
                  ...
                  <p>
                    We provide quick and efficient issue resolution, addressing
                    any technical problems to minimize downtime and keep your
                ...
                <div className="grid gap-3">
                  ...
                  <p>
                    Our remote support services ensure you receive prompt
                    assistance no matter where you are. We troubleshoot and
                    resolve issues remotely, providing convenience and
                    efficiency.
                  </p>
                </div>
              </div>
            ...
            <p>
              With our helpdesk support services, you can be confident that your
              IT systems are in good hands. Experience the benefits of reliable
              and responsive support with GSquare Technologies.
            </p>
            ...
            <div className="mt-2.5 grid grid-cols-1 gap-6 md:grid-cols-[1fr_260px]">
              <div className="grid items-baseline gap-6 lg:gap-9">
                <div>
                  ...
                  <p>
                    From issue resolution to remote support and preventive
                    maintenance, we offer comprehensive helpdesk services
                    tailored to your specific needs. Our proactive approach
                    ensures potential problems are addressed before they affect
                    your business.
                  </p>
                </div>
                <div>
                  ...
                  <p>
                    Our preventive maintenance services keep your systems
                    running smoothly by identifying and resolving potential
                    issues before they become major problems, ensuring
                ...
                <div>
                  ...
                  <p>
                    ...
                    business while we take care of your IT needs. Our team is
                    dedicated to providing the best possible support to keep
