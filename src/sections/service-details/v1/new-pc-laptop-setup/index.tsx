...
const services: LinkProps[] = [
  {
    label: 'Custom PC Configuration',
    href: '/services/new-pc-laptop-setup',
  },
  {
    label: 'Software Installation & Licensing',
    href: '/services/new-pc-laptop-setup',
  },
  {
    label: 'Data Migration & Backup',
    href: '/services/new-pc-laptop-setup',
  },
  {
  ...
  {
    label: 'Security Software Setup',
    href: '/services/new-pc-laptop-setup',
  },
  {
    label: 'Peripherals Configuration',
    href: '/services/new-pc-laptop-setup',
  },
  {
    label: 'User Account Setup',
    href: '/services/new-pc-laptop-setup',
  },
  {
      ...
      <Container>
        <div className="grid items-start gap-10 md:grid-cols-[390px_1fr] 2xl:gap-[50px]">
          ...
          <div className="grid gap-10 md:sticky md:top-[76px] lg:top-[133px] 2xl:gap-[60px]">
            ...
            <div className="grid gap-30px">
              <div className="relative z-1 bg-accent-100 p-10 dark:bg-accent-700">
                <p>
                  Unleash the full potential of your new technology with our
                  expert setup services. We transform your out-of-the-box PC or
                  laptop into a finely-tuned, personalized powerhouse. From
                  seamless data transfer to optimized performance, we ensure
                  your new device is ready to elevate your productivity from day
                  one. Experience the perfect blend of cutting-edge hardware and
                  tailored configuration - your gateway to effortless computing
                  starts here.
                </p>
          ...
          <div className="grid gap-6">
            ...
            <p>
              Welcome to our New PC/Laptop Setup service. At GSquare
              Technologies, we ensure your new PC or laptop is set up seamlessly
              and optimized for peak performance from the start. Our
              comprehensive setup services meet your specific needs, ensuring
              your device is ready with all necessary software and settings
              configured for optimal performance and reliability.
            </p>
            <p>
              Our expert team assists you with hardware selection, ensuring you
              get the best device that meets your performance requirements and
              budget. We handle the installation of essential software,
              including your preferred operating system, security software, and
              productivity tools. Finally, we optimize your system settings to
            ...
            <div className="my-10 grid items-center gap-8 md:grid-cols-2">
              ...
              <div className="grid gap-4">
                <div className="grid gap-3">
                  ...
                  <p>
                    We ensure the best implementation of hardware and software
                    to meet your needs, ensuring a seamless and efficient setup
                    process.
                  </p>
                </div>
                <div className="grid gap-3">
                  ...
                  <p>
                    Our optimization services ensure your new PC or laptop runs
                    smoothly and efficiently, providing you with a reliable and
                    high-performing device from day one.
                  </p>
                </div>
              </div>
            </div>
            ...
            <p>
              With our New PC/Laptop Setup service, you can be confident that
              your new device will be ready to use immediately, with all
              necessary configurations and installations handled by our expert
              team. Experience hassle-free setup and optimized performance with
              GSquare Technologies.
            </p>
            ...
            <div className="mt-2.5 grid grid-cols-1 gap-6 md:grid-cols-[1fr_260px]">
              <div className="grid items-baseline gap-6 lg:gap-9">
                <div>
                  ...
                  <p>
                    Our team of professionals provides expert guidance in
                    selecting the right hardware and software solutions for your
                    specific needs.
                  </p>
                </div>
                <div>
                  ...
                  <p>
                    We offer customized setup solutions tailored to your unique
                    requirements, ensuring your new device is perfectly suited
                    to your needs.
                  </p>
                </div>
                <div>
                  ...
                  <p>
                    Enjoy ongoing support and maintenance to keep your device
