...
const services: LinkProps[] = [
  {
    label: 'Custom CCTV System Design',
    href: '/services/cctv-setup',
  },
  {
    label: 'IP Camera Installation',
    href: '/services/cctv-setup',
  },
  {
    label: 'Remote Monitoring Setup',
    href: '/services/cctv-setup',
  },
  // {
  //   label: 'Video Analytics Integration',
  //   href: '/',
  // },
  {
  ...
  // {
  //   label: 'CCTV Maintenance Plans',
  //   href: '/',
  // },
  {
    label: 'Wireless CCTV Solutions',
    href: '/services/cctv-setup',
  },
  {
      ...
      <Container>
        <div className="grid items-start gap-10 md:grid-cols-[390px_1fr] 2xl:gap-[50px]">
          ...
          <div className="grid gap-10 md:sticky md:top-[76px] lg:top-[133px] 2xl:gap-[60px]">
            ...
            <div className="grid gap-30px">
              <div className="relative z-1 bg-accent-100 p-10 dark:bg-accent-700">
                <p>
                  Secure your world with cutting-edge CCTV solutions. Our
                  advanced surveillance systems provide peace of mind, protect
                  your assets, and deter threats. Experience the power of 24/7
                  vigilance with crystal-clear footage and smart analytics.
                  Safeguard what matters most - choose our CCTV expertise for
          ...
          <div className="grid gap-6">
            ...
            <p>
              At GSquare Technologies, we specialize in providing top-notch CCTV
              setup services to enhance your security. Our advanced surveillance
              systems are designed to meet your specific needs, ensuring your
              premises are protected around the clock.
            </p>
            <p>
              Our comprehensive services include site assessment, installation,
              and ongoing maintenance. We work closely with you to evaluate your
              security requirements and design a system that offers maximum
            ...
            <div className="my-10 grid items-center gap-8 md:grid-cols-2">
              ...
              <div className="grid gap-4">
                <div className="grid gap-3">
                  ...
                  <p>
                    Our experts conduct a thorough site assessment to identify
                    the most vulnerable areas and determine the best positions
                    for your CCTV cameras.
                  </p>
                </div>
                <div className="grid gap-3">
                  <div className="flex items-center gap-4">
                  ...
                  <p>
                    We provide professional installation services, ensuring that
                    your surveillance system is set up correctly and functions
            ...
            <p>
              Our maintenance services ensure your system continues to operate
              smoothly, with regular check-ups and updates. Experience the peace
              of mind that comes with knowing your security is in expert hands
              with GSquare Technologies.
            </p>
            ...
            <div className="mt-2.5 grid grid-cols-1 gap-6 md:grid-cols-[1fr_260px]">
              <div className="grid items-baseline gap-6 lg:gap-9">
                <div>
                  ...
                  <p>
                    From initial assessment to installation and ongoing
                    maintenance, we offer comprehensive services to ensure your
                    surveillance system meets your needs. Our solutions are
                    tailored to your specific security requirements, providing
                ...
                <div>
                  ...
                  <p>
                    Our reliable maintenance services ensure your CCTV system is
                    always up and running, providing continuous protection. We
                    offer ongoing support to address any issues promptly and
                    efficiently.
                  </p>
                </div>
                <div>
                  ...
                  <p>
                    With our advanced surveillance systems, you can be confident
                    that your property is secure. Our high-quality cameras and
                    monitoring solutions offer superior performance and peace of
                    mind.
                  </p>
                </div>
              </div>
