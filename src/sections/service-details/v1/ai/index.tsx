      ...
      <Container>
        <div className="grid items-start gap-10 md:grid-cols-[390px_1fr] 2xl:gap-[50px]">
          ...
          <div className="grid gap-10 md:sticky md:top-[76px] lg:top-[133px] 2xl:gap-[60px]">
            ...
            <div
              className={cn(
                ...
                // before
                'before:absolute before:inset-0 before:z-[2] before:[background:linear-gradient(180deg,rgba(30,140,244,20%)_0%,rgba(30,140,244,60%)_50%,rgba(30,140,244)_100%)]'
              )}
            >
              <Image
            ...
            <div className="grid gap-30px">
              <div className="relative z-1 bg-accent-100 p-10 dark:bg-accent-700">
                <p>
                  Harness the power of AI to transform your business. From
                  predictive analytics to intelligent automation, our AI
                  solutions unlock hidden potentials, drive innovation, and give
                  you the competitive edge in todays data-driven world. Step
                  into the future with AI - where possibilities are limitless
          ...
          <div className="grid gap-6">
            ...
            <p>
              At GSquare Technologies, we specialize in providing cutting-edge
              AI solutions to enhance your business operations. Our advanced
              artificial intelligence systems are designed to meet your specific
              needs, ensuring your organization stays at the forefront of
              technological innovation. We offer a range of services including
              AI strategy consultation, custom AI development, and seamless
              integration of AI capabilities into your existing systems and
              workflows.
            </p>
            <p>
              Our comprehensive approach begins with a thorough assessment of
              your business requirements, followed by the design and
              implementation of tailored AI solutions. Our team of expert data
              scientists and engineers develop custom AI models and applications
              specific to your industry and use case. We do not just implement
              and leave; we provide ongoing support, maintenance, and
              optimization to ensure your AI systems continue to deliver maximum
              value and efficiency over time.
            </p>
            <div className="my-10 grid items-center gap-8 md:grid-cols-2">
              ...
              <div className="grid gap-4">
                <div className="grid gap-3">
                  ...
                  <p>
                    Our AI experts conduct a thorough assessment of your
                    business processes to identify areas where AI can provide
                    the most value and determine the best AI solutions for your
                    specific needs.
                  </p>
                </div>
                <div className="grid gap-3">
                  ...
                  <p>
                    We provide professional AI development services, ensuring
                    that your AI systems are built correctly and function
                    optimally from implementation to scaling.
                  </p>
                </div>
              </div>
            </div>
            <p>
              Our ongoing support and optimization services ensure your AI
              systems continue to operate efficiently, with regular updates and
              performance enhancements. Experience the transformative power of
              AI in expert hands with GSquare Technologies.
            </p>
            my-10 grid items-center gap-8 md:grid-cols-2
            <div className="mt-2.5 grid grid-cols-1 gap-6 md:grid-cols-[1fr_260px]">
              <div className="grid items-baseline gap-6 lg:gap-9">
                <div>
                  <h3 className="text-md font-bold text-accent-700 dark:text-white">
                    Comprehensive & Tailored AI Solutions
                  </h3>
                  <p>
                    From initial consultation to development and ongoing
                    optimization, we offer comprehensive AI services to ensure
                    your systems meet your business objectives. Our solutions
                    are tailored to your specific industry and use case,
                    providing optimal value and efficiency for your
                    organization.
                  </p>
                </div>
                <div>
                  <h3 className="text-md font-bold text-accent-700 dark:text-white">
                    Reliable AI Integration and Support
                  </h3>
                  <p>
                    Our reliable integration services ensure your AI systems
                    seamlessly work with your existing infrastructure. We offer
                    ongoing support to address any issues promptly and
                    efficiently, ensuring continuous AI-driven improvements in
                    your operations.
                  </p>
                </div>
                <div>
                  ...
                  <p>
                    With our advanced AI systems, you can be confident in making
                    data-driven decisions. Our high-quality AI models and
                    analytics solutions offer superior insights and competitive
