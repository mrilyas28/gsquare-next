...
const services: LinkProps[] = [
  ...
  {
    label: 'Cloud Security Solutions',
    href: '/services/cloud-computing',
  },
  {
        ...
        <div className="grid items-start gap-10 md:grid-cols-[390px_1fr] 2xl:gap-[50px]">
          ...
          <div className="grid gap-10 md:sticky md:top-[76px] lg:top-[133px] 2xl:gap-[60px]">
            ...
            <div className="grid gap-30px">
              <div className="relative z-1 bg-accent-100 p-10 dark:bg-accent-700">
                <p>
                  Cloud computing revolutionizes business operations, offering
                  scalability, flexibility, and cost-efficiency. It empowers
                  organizations to innovate faster, collaborate more
                  effectively, and adapt swiftly to market demands. By
                  leveraging cloud technologies, companies can focus on their
                  core mission while accessing cutting-edge IT resources,
          ...
          <div className="grid gap-6">
            ...
            <p>
              ...
              providing scalable and flexible solutions that enable seamless
              integration and optimal performance. At GSquare Technologies, we
              understand the importance of leveraging the power of the cloud to
              drive efficiency and growth. Our expert team is dedicated to
              delivering custom cloud solutions tailored to your unique business
              requirements, ensuring that you can harness the full potential of
              cloud technology.
            </p>
            <p>
              With our comprehensive cloud computing services, you can
              experience the benefits of secure and reliable data migration,
              ensuring a smooth transition to the cloud environment. Our ongoing
              cloud management support guarantees that your infrastructure
              remains optimized and performant, allowing you to focus on your
              core business objectives. By partnering with GSquare Technologies,
              you can embrace the future of technology and unlock new
              opportunities for innovation and success in the digital landscape.
            </p>
            <div className="my-10 grid items-center gap-8 md:grid-cols-2">
              ...
              <div className="grid gap-4">
                <div className="grid gap-3">
                  ...
                  <p>
                    Our cloud solutions are built on a scalable infrastructure,
                    allowing you to adjust resources based on your business
                    needs for optimal performance and cost-efficiency.
                  </p>
                </div>
                <div className="grid gap-3">
                  <div className="flex items-center gap-4">
                  ...
                  <p>
                    We integrate your cloud environment with existing systems
                    for seamless collaboration and data exchange.
                  </p>
                </div>
              </div>
            </div>
            ...
            <p>
              By leveraging our cloud computing services, you can benefit from
              enhanced collaboration, improved business continuity, and reduced
              IT costs. Our solutions are designed to scale with your business,
              providing the flexibility and agility needed to stay competitive
              in todays fast-paced digital landscape. With GSquare Technologies
              as your trusted cloud partner, you can confidently embrace the
              power of the cloud and unlock new opportunities for growth and
              innovation.
            </p>
              ...
              <div className="grid items-baseline gap-6 lg:gap-9">
                <div>
                  ...
                  <p>
                    ...
                    requirements and develop customized cloud solutions that
                ...
                <div>
                  ...
                  <p>
                    Our experts ensure a smooth and secure migration of your
                    data to the cloud, minimizing disruptions and ensuring data
                ...
                <div>
                  ...
                  <p>
                    We continuously monitor and optimize your cloud environment
                    to ensure optimal performance, security, and
                    cost-efficiency, allowing you to focus on your core business
                    activities.
                  </p>
                </div>
              </div>
