...
const services: LinkProps[] = [
  ...
  {
    label: 'Server Installation & Configuration',
    href: '/services/office-it-infrastructure-setup',
  },
  {
    label: 'Workstation Deployment',
    href: '/services/office-it-infrastructure-setup',
  },
  {
  ...
  // {
  //   label: 'VoIP Phone Systems Setup',
  //   href: '/',
  // },
  {
    label: 'Data Backup & Recovery Solutions',
    href: '/services/office-it-infrastructure-setup',
  },
  {
      ...
      <Container>
        <div className="grid items-start gap-10 md:grid-cols-[390px_1fr] 2xl:gap-[50px]">
          ...
          <div className="grid gap-10 md:sticky md:top-[76px] lg:top-[133px] 2xl:gap-[60px]">
            ...
            <div className="grid gap-30px">
              <div className="relative z-1 bg-accent-100 p-10 dark:bg-accent-700">
                <p>
                  Empower your business with a robust IT foundation. Our
                  comprehensive office IT infrastructure setup transforms your
                  workspace into a high-performance, secure digital environment.
                  From seamless networking to cutting-edge security measures, we
                  build the technological backbone that propels your business
                  forward. Experience the synergy of perfectly integrated
                  systems, enhanced productivity, and scalable solutions
                  designed for your success. Step into the future of work with
                  our expert IT infrastructure services.
                </p>
          ...
          <div className="grid gap-6">
            ...
            <p>
              At GSquare Technologies, we specialize in setting up robust IT
              infrastructure for offices. Our services ensure a connected
              workplace, providing seamless network design, hardware
              installation, and comprehensive maintenance plans.
            </p>
            <p>
              Our team works closely with you to understand your business needs,
              delivering an IT infrastructure that is reliable and scalable.
              From network setup to ongoing support, we ensure your office
            ...
            <div className="my-10 grid items-center gap-8 md:grid-cols-2">
              ...
              <div className="grid gap-4">
                <div className="grid gap-3">
                  ...
                  <p>
                    We design efficient and secure network systems that meet the
                    specific demands of your office, ensuring reliable
                ...
                <div className="grid gap-3">
                  ...
                  <p>
                    Our professional installation services cover all your
                    hardware needs, from servers and workstations to network
                    devices, ensuring everything is set up correctly and
                    efficiently.
                  </p>
                </div>
              </div>
            ...
            <p>
              With our IT infrastructure setup services, you can be confident
              that your office is equipped with the latest technology, enabling
              a productive and connected workplace. Experience the benefits of a
              reliable IT setup with GSquare Technologies.
            </p>
            ...
            <div className="mt-2.5 grid grid-cols-1 gap-6 md:grid-cols-[1fr_260px]">
              <div className="grid items-baseline gap-6 lg:gap-9">
                <div>
                  ...
                  <p>
                    From network design to hardware installation and ongoing
                    maintenance, we offer comprehensive services to meet all
                    your IT infrastructure needs. Our solutions are tailored to
                    your specific requirements, ensuring your office operates
                ...
                <div>
                  ...
                  <p>
                    Our reliable maintenance plans ensure your IT infrastructure
                    remains up-to-date and fully functional. We provide ongoing
                    support to address any issues and keep your systems running
                    smoothly.
                  </p>
                </div>
                <div>
                  ...
                  <p>
                    With our advanced network solutions, your office will
                    benefit from enhanced connectivity and performance, enabling
                    your team to work more effectively and collaboratively.
                  </p>
                </div>
              </div>
              <Image
