...
const services: LinkProps[] = [
  {
    label: 'Hardware Diagnostics & Repair',
  ...
  {
    label: 'Operating System Reinstallation',
    href: '/services/pc-laptop-repair',
  },
  {
      ...
      <Container>
        <div className="grid items-start gap-10 md:grid-cols-[390px_1fr] 2xl:gap-[50px]">
          ...
          <div className="grid gap-10 md:sticky md:top-[76px] lg:top-[133px] 2xl:gap-[60px]">
            ...
            {/* Cta box  after:bg-accent-700/95  */}
            <div
              className={cn(
            ...
            <div className="grid gap-30px">
              <div className="relative z-1 bg-accent-100 p-10 dark:bg-accent-700">
                <p>
                  Breathe new life into your technology with our expert PC and
                  laptop repair services. From frustrating glitches to major
                  malfunctions, we diagnose and resolve issues with precision
                  and care. Our skilled technicians combine cutting-edge tools
                  with years of experience to revive your devices, often
                  exceeding their original performance. Do not let tech troubles
                  slow you down - trust us to keep your digital world running
          ...
          <div className="grid gap-6">
            ...
            <p>
              At GSquare Technologies, we ensure your new PC or laptop setup is
              seamless and optimized for peak performance from the start. Our
              comprehensive setup services are designed to meet your specific
              needs, ensuring that your device is ready to use with all
              necessary software and settings configured for optimal performance
              and reliability.
            </p>
            <p>
