      ...
      <Container>
        <div className="grid items-start gap-10 md:grid-cols-[390px_1fr] 2xl:gap-[50px]">
          ...
          <div className="grid gap-10 md:sticky md:top-[76px] lg:top-[133px] 2xl:gap-[60px]">
            ...
            <div className="grid gap-30px">
              <div className="relative z-1 bg-accent-100 p-10 dark:bg-accent-700">
                <p>
                  Transform your ideas into powerful, tailor-made software
                  solutions. Our expert developers craft cutting-edge
                  applications that streamline your operations, engage your
                  customers, and drive your business forward. From concept to
                  deployment, we blend innovative technology with your unique
                  vision to create software that is not just functional, but
                  transformative. Unlock your business full potential with
                  custom software that evolves with your needs and keeps you
          ...
          <div className="grid gap-6">
            ...
            <p>
              At GSquare Technologies, we specialize in delivering innovative
              software solutions custom-made to meet your unique business needs.
              Our services include application development, system integration,
              and quality assurance, ensuring the highest quality and
              performance.
            </p>
            <p>
              Our expert team collaborates closely with you to understand your
              requirements and goals, delivering software that not only meets
              but exceeds your expectations. From initial concept to final
              deployment, we ensure your solutions are robust, scalable, and
              reliable.
            </p>
              ...
              <div className="grid gap-4">
                <div className="grid gap-3">
                  ...
                  <p>
                    ...
                    needs, ensuring they are user-friendly, efficient, and
                    scalable.
                  </p>
                </div>
                <div className="grid gap-3">
                  ...
                  <p>
                    Our system integration services ensure seamless connectivity
                    and interoperability between your various software and
                    hardware systems, enhancing overall efficiency.
                  </p>
                </div>
              </div>
            </div>
            ...
            <p>
              With our software development services, you can be confident that
              your solutions will be innovative, reliable, and of the highest
              quality. Experience the difference with GSquare Technologies.
            </p>
            ...
            <div className="mt-2.5 grid grid-cols-1 gap-6 md:grid-cols-[1fr_260px]">
              <div className="grid items-baseline gap-6 lg:gap-9">
                <div>
                  ...
                  <p>
                    From application development to system integration and
                    quality assurance, we offer comprehensive software solutions
                    tailored to your specific requirements. Our approach ensures
                    your software aligns perfectly with your business goals.
                  </p>
                </div>
                <div>
                  <h3 className="text-md font-bold text-accent-700 dark:text-white">
                  ...
                  <p>
                    Our quality assurance services guarantee that your software
                    is thoroughly tested and meets the highest standards of
                ...
                <div>
                  ...
                  <p>
                    With our reliable support services, you can focus on your
                    business while we take care of your software needs. Our team
                    is dedicated to providing the best possible support to keep
