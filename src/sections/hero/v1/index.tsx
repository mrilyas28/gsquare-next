              ...
              >
                ...
                <div
                  className={cn(
                    ...
                    styles['hero-bg'],
                    // before
                    // 'before:absolute before:inset-0 before:bg-[#14141600] before:opacity-80  dark:before:bg-accent-700',
                    'before:absolute before:inset-0 before:bg-[#ffffff00] before:opacity-80  dark:before:bg-[rgba(255,255,255,0)]',
                    // after
                    // 'after:[background:linear-gradient(180deg,rgba(255,255,255,0)_0%,255,255,255,0)_50%,#FFFFFF_100%)] after:absolute  after:inset-0  dark:after:[background:linear-gradient(180deg,rgba(20,20,22,0.00)_0%,rgba(20,20,22,0.00)_50%,#141416_100%)]'
                    'after:absolute after:inset-0 after:[background:linear-gradient(180deg,rgba(255,255,255,50)_0%,rgba(255,255,255,0)_50%,#FFFFFF_100%)] dark:after:[background:linear-gradient(180deg,rgba(20,20,22,50)_0%,rgba(20,20,22,0)_50%,#141416_100%)]'
                  )}
