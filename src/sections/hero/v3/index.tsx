...
export function HeroSection({ title, breadcrumbItems }: HeroSectionProps) {
  return (
    <section className="section-padding-primary relative flex min-h-[450px] items-center">
      ...
      {/* Overlay  */}
      <span className="absolute inset-0 bg-gradient-1 from-white/0 via-white/50 to-white dark:from-accent-900/0 dark:via-accent-900/30 dark:to-accent-900"></span>
