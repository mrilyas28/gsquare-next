...
import { ServiceDetailsSection } from '@/src/sections/service-details/v1/web-design-and-development';
import { Metadata } from 'next';

export const metadata: Metadata = {
  title: 'GSquare Technologies | Service details | Web Design and Development',
  description:
