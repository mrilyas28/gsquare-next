...
import { ServiceDetailsSection } from '@/src/sections/service-details/v1/office-it-infrastructure-setup';
import { Metadata } from 'next';

export const metadata: Metadata = {
  title:
    'GSquare Technologies | Service details | Office IT Infrastructure Setup',
  description:
